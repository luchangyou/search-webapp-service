//highstock K线图
var highStockChart = function(divID,reportId,result,crrentData,chartType){
	
	var $reporting = $("#"+reportId);
	var firstTouch = true;
	...
	// 定义 月份 均均线数组
	var MA3MArray=[], MA6MArray=[],MA12MArray=[];
	
	//定义 月k 均线数组
	var MA5WArray=[],MA10WArray=[];MA21WArray=[];
...
//			}], 
	    ...
	    tooltip: {
		   formatter: function() {
			   ...
			   if("monthChart"==chartType){
				   
				   
				   
				   if(this.points[2]){
					   MA3M =this.points[2].y.toFixed(2);
				   }
				   
				   if(this.points[3]){
					   MA6M =this.points[3].y.toFixed(2);
				   }
				  
				   
				   if(this.points[4]){
					   MA12M =this.points[4].y.toFixed(2);
				   }
			   ...
			   if("weekChart"==chartType){
				   
				   
				   if(this.points[2]){
					   MA5W =this.points[2].y.toFixed(2);
				   }
				   
				   if(this.points[3]){
					   MA10W =this.points[3].y.toFixed(2);
				   }
				  
				   
				   if(this.points[4]){
					   MA21W =this.points[4].y.toFixed(2);
				   }
    		  ...
    		  if("dayChart"==chartType){
    			  ...
    			  $reporting.html(
        				...
        				+'  <span>收盘:</span>'+close
                  		...
                  		+'  <span>最低:</span>'+ low
                  		+'  <span style="padding-left:25px;"> </span>'+	Highcharts.dateFormat('%Y-%m-%d',this.x)
                  		+'	<br/><b style="color:#1aadce;padding-left:25px">MA3M</b> '+ MA3M
                  		+'  <b style="color: #8bbc21;padding-left:150px">MA6M</b> '+ MA6M
                  		+'  <b style="color:#910000;padding-left:150px">MA12M</b> '+ MA12M
                  		);
    		  }else if("weekChart"==chartType){
    			  ...
    			  $reporting.html(
        				...
        				+'  <span>收盘:</span>'+close
                  		...
                  		+'  <span>最低:</span>'+ low
                  		+'  <span style="padding-left:25px;"> </span>'+	Highcharts.dateFormat('%Y-%m-%d',this.x)
                  		+'	<br/><b style="color:#1aadce;padding-left:25px">MA5W</b> '+ MA5W
                  		+'  <b style="color: #8bbc21;padding-left:150px">MA10W</b> '+ MA10W
                  		+'  <b style="color:#910000;padding-left:150px">MA21W</b> '+ MA21W
                  		);
