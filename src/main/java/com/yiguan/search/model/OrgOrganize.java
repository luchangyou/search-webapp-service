...
public class OrgOrganize implements Serializable {
    ...
    public static String getRonameColumnString() {
        return "roname";
    }
    ...
    public String getRouuid() {
        return rouuid;
    }

    public static String getRouuidColumnString() {
        return "rouuid";
    }

    public void setRouuid(String rouuid) {
        this.rouuid = rouuid == null ? null : rouuid.trim();
    }
    ...
    public String toString() {
        ...
        colStr += ", " + getRonameColumnString()+":"+getRoname();
        ...
        colStr += ", " + getRouuidColumnString()+":"+getRouuid();
